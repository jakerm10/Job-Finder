...
const TRACKS = {
  ...
  leadership: {
    ...
    projects: [
      { name: 'Gameday Stats', when: 'In Progress', desc: 'Owning a real-world, self-directed technical project end-to-end — from requirements through schema design — allowing users to selectively find statistics from individual games, players, and teams. Built with Python and SQL.' },
