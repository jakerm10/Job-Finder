...
**Track focus:** Data / Database Engineering
...
- GPA: 3.578
- Relevant Coursework: Design and Analysis of Database Systems, Computer Algorithms, Software Development: Full Stack
...
- **Other:** Data Analysis, Statistical Analysis, Analytical Problem Solving, AI Prompt Engineering
...
- Removes the need for users to manually acquire data by leveraging SQL techniques to select, filter, engineer, analyze, and maintain stats across a relational database
- Built with Python and SQL

**Personal Portfolio Website** — Summer 2026
- Developed a full-stack site using React.js, EmailJS, Cloudflare, and Firebase, including SQL-backed account creation/modification and data persistence
- Handled deployment pipelines and user event/data flows end-to-end

**Photo Sorter** — Winter 2025-26
- Built a file-processing script that parses and rewrites MacOS metadata, applying structured data transformations across a batch file set
...
- 2026-09-26: Adjusted for this week's data-science-leaning cluster (GridX Data Science Intern — Tier C, fit 5, Denver CO; Perpay Data Science Internship — Tier C, fit 4; F.N.B. Corporation Data Engineering Intern and Affinius Capital Data Scientist Intern — both Tier B, fit 4). Added "analyze" to the Gameday Stats SQL-technique bullet, mirroring the statistical-modeling/data-science framing all four postings share, grounded in the project's existing use of query logic to surface stats (and Jake's Statistics minor/R-Studio skill). No changes needed for the Tier A long-shot adds (Lyft, Jane Street, Lazard, Figma) per this run's minimal-effort-on-Tier-A policy.
